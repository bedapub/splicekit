...
RUN apt-get install -y python3-dev zlib1g-dev libbz2-dev liblzma-dev libncurses5-dev libcurl4-openssl-dev libssl-dev libopenmpi-dev openmpi-bin ghostscript libgs-dev libgd-dev libexpat1-dev zlib1g-dev libxml2-dev autoconf automake libtool libhtml-template-compiled-perl libxml-opml-simplegen-perl libxml-libxml-debugging-perl
